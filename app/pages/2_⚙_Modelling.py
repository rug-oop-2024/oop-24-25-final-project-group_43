...
def load_features(datasett):
    features = detect_feature_types(datasett)
    return features


def determine_task_type(input_features, target_feature, features):
...
def display_summary(selected_dataset_name, input_features, target_feature, model_type, split_ratio, metrics):
...
def train_model(datasett, features,  input_features, target_feature, model_type, split_ratio, metrics):
...
if input_features and target_feature:
        ...
        display_summary(selected_dataset.name, input_features, target_feature, model_type, split_ratio, metrics)
        result = train_model(datasett, features, input_features, target_feature, model_type, split_ratio, metrics)
        if result:
            print_result(result)
